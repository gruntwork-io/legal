...
<!--Plain English:
You can’t transfer this agreement to someone else, but if you’re acquired by or merged with another company, the agreement will transfer to the new company.
-->
...
<!--Plain English:
If we have a dispute, we’ll attempt to settle it directly with each other for at least 30 days. If that fails, either of us can bring a court action in the state of Delaware.
-->
...
<!--Plain English:
This agreement overrides any other verbal or other written agreement we might have related to the services.
-->
